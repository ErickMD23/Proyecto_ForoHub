...
import com.alura.foro.api.dto.security.JWTtoken;
import com.alura.foro.api.dto.usuario.AutenticacionDeUsuario;
...
public class AuthenticationController {
    ...
    @PostMapping
    public ResponseEntity autenticarUsuario(@RequestBody @Valid AutenticacionDeUsuario datosAutenticacion) {
